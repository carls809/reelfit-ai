...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[min(92vw,34rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[2rem] border border-white/60 bg-card/95 p-6 shadow-card backdrop-blur-xl duration-200 dark:border-white/10",
        className
      )}
      {...props}
    >
