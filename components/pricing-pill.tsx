...
export function PricingPill({
  ...
  return (
    <div className="fixed right-6 top-6 z-30 hidden items-center gap-3 rounded-full border border-white/60 bg-white/85 p-2 pr-4 shadow-card backdrop-blur-xl dark:border-white/10 dark:bg-zinc-950/80 xl:flex">
